    ...
    public class DistributorsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var distributor = await _context.Distributors
                .Include(d => d.Orders).ThenInclude(o => o.Product).ThenInclude(p => p.Trademark)
                .Include(d => d.Orders).ThenInclude(o => o.Product).ThenInclude(p => p.ProductType)
                .Include(d => d.Orders).ThenInclude(o => o.Product).ThenInclude(p => p.Flavor)
                .Include(d => d.Orders).ThenInclude(o => o.Product).ThenInclude(p => p.Weight)
