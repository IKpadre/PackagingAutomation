...
using PackagingAutomation.Resources;
...
namespace PackagingAutomation.Controllers
{
    public class TrademarksController : Controller
    {
        ...
        public TrademarksController(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var trademark = await _context.Trademarks
                .Include(t => t.Products).ThenInclude(p => p.ProductType)
                .Include(t => t.Products).ThenInclude(p => p.Flavor)
                .Include(t => t.Products).ThenInclude(p => p.Weight)
